 ...
 * Example:
 * http://localhost:8080/BookingServer2/get_venue_bookings?actionUser=admin&venueId=1 - Receive all bookings.
 * http://localhost:8080/BookingServer2/get_venue_bookings?actionUser=admin&venueId=1&status=2 - Receive only approved bookings.
 */
public class GetVenueBookingsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String, Object> bookingsForVenue = VenuesDAO.getBookingsForVenue(actionUser, venueId, filterStatus);
