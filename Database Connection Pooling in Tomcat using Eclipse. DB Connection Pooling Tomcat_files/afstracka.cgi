...
S+="&Tips="+T;
var codeAFS="<a href=\"http://new.addfreestats.com/?usr="+AFS_Account+"\" rel=\"nofollow\">";
codeAFS+="<img border=\"0\" src=\"http://"+AFS_Server+".addfreestats.com/cgi-bin/connect.cgi?";
codeAFS+=S;
codeAFS+="\" alt=\"AFS\"></a>";
...
if (flag==0) elements[i].onclick = afsstlogc; 
   }
 }
